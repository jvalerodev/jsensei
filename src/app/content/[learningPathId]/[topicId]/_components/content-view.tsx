...
export function TopicContentView({
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="prose prose-slate max-w-none">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    lessonContent.content?.content?.replace(/\n/g, "<br />") ||
                    ""
                }}
              />
            </div>
            ...
            {lessonContent.content?.examples &&
              lessonContent.content.examples.length > 0 && (
                <div className="mt-6">
                  ...
                  <div className="space-y-4">
                    {lessonContent.content.examples.map(
      ...
      {/* Exercises */}
      {exerciseContent &&
        exerciseContent.content?.exercises &&
        exerciseContent.content.exercises.length > 0 && (
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent>
              <div className="space-y-6">
                {exerciseContent.content.exercises.map(
